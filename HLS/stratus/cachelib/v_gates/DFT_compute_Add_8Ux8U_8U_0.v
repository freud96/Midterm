...
// Generated on: Apr 24 2022 14:17:28 CST (Apr 24 2022 06:17:28 UTC)

module DFT_compute_Add_8Ux8U_8U_0(in2, in1, out1);
  input [7:0] in2, in1;
  output [7:0] out1;
  wire [7:0] in2, in1;
  wire [7:0] out1;
  ...
  MXI2X1 g9436(.A (n_0), .B (in2[0]), .S0 (in1[0]), .Y (out1[0]));
  ...
  XNOR2X1 g9440(.A (in1[7]), .B (in2[7]), .Y (n_12));
  NOR2X1 g9454(.A (in1[6]), .B (in2[6]), .Y (n_1));
  NAND2X4 g9444(.A (in2[3]), .B (in1[3]), .Y (n_15));
  NOR2X4 g9447(.A (in1[4]), .B (in2[4]), .Y (n_10));
  NOR2X4 g9448(.A (in1[5]), .B (in2[5]), .Y (n_6));
  NOR2X8 g9446(.A (in1[2]), .B (in2[2]), .Y (n_42));
  NAND2X6 g9443(.A (in2[5]), .B (in1[5]), .Y (n_7));
  AND2XL g9453(.A (in1[6]), .B (in2[6]), .Y (n_8));
  NAND2X4 g9456(.A (in1[2]), .B (in2[2]), .Y (n_17));
  NOR2X4 g9458(.A (in1[3]), .B (in2[3]), .Y (n_16));
  INVX1 g9459(.A (in2[0]), .Y (n_0));
  ...
  NAND2X8 g9469_dup_dup(.A (in1[4]), .B (in2[4]), .Y (n_130));
  ...
  NAND2X8 g82(.A (in2[0]), .B (in1[0]), .Y (n_211));
  NOR2X8 g79(.A (in2[1]), .B (in1[1]), .Y (n_212));
  NAND2X2 g81(.A (in1[1]), .B (in2[1]), .Y (n_213));
  NAND2X6 g80(.A (in2[1]), .B (in1[1]), .Y (n_215));
  NAND2X1 g9469_dup9505(.A (in1[4]), .B (in2[4]), .Y (n_219));
  NAND2X6 g9506(.A (in1[0]), .B (in2[0]), .Y (n_220));
