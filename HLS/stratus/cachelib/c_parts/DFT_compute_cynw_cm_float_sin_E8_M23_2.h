...
#ifndef DFT_compute_cynw_cm_float_sin_E8_M23_2_COMPILED
#define DFT_compute_cynw_cm_float_sin_E8_M23_2_COMPILED

SC_MODULE(DFT_compute_cynw_cm_float_sin_E8_M23_2) // architecture "behavioural"
{
...
#    if !defined(CYNTHVLG)
    ...
    // part assign: lhs_part_439(1): x(32,32)
    sc_signal<sc_uint<1> > lhs_part_439;
    void method_0() {
        lhs_part_439 = sc_uint<1>(
    ...
    // part assign: lhs_part_440(1): inst_cellmath__42(5,0)
    sc_signal<sc_uint<6> > lhs_part_440;
    void method_13() {
        lhs_part_440 = sc_uint<6>(
    ...
    // part assign: lhs_part_441(1): inst_cellmath__48_32_0_(24,0)
    sc_signal<sc_uint<25> > lhs_part_441;
    void method_14() {
        lhs_part_441 = sc_uint<25>(
    ...
    // part assign: lhs_part_442(1): inst_cellmath__195(29,4)
    sc_signal<sc_uint<26> > lhs_part_442;
    void method_22() {
        lhs_part_442 = sc_uint<26>(
    ...
    // part assign: lhs_part_443(2): inst_cellmath__195(3,0)
    sc_signal<sc_uint<4> > lhs_part_443;
    void method_23() {
        lhs_part_443 = sc_uint<4>(
    ...
    // part assign: lhs_part_444(1): inst_cellmath__197__131(20,20)
    sc_signal<sc_uint<1> > lhs_part_444;
    void method_24() {
        lhs_part_444 = sc_uint<1>(
    ...
    // part assign: lhs_part_445(1): inst_cellmath__197(2,0)
    sc_signal<sc_uint<3> > lhs_part_445;
    void method_25() {
        lhs_part_445 = sc_uint<3>(
    ...
    // part assign: lhs_part_446(2): inst_cellmath__197__131(19,0)
    sc_signal<sc_uint<20> > lhs_part_446;
    void method_26() {
        lhs_part_446 = sc_uint<20>(
    ...
    // part assign: lhs_part_447(2): inst_cellmath__197(20,18)
    sc_signal<sc_int<3> > lhs_part_447;
    void method_27() {
        lhs_part_447 = sc_int<3>(
    ...
    // part assign: lhs_part_448(3): inst_cellmath__197(17,3)
    sc_signal<sc_uint<15> > lhs_part_448;
    void method_28() {
        lhs_part_448 = sc_uint<15>(
    ...
    // part assign: lhs_part_449(1): inst_cellmath__200(48,0)
    sc_signal<sc_uint<49> > lhs_part_449;
    void method_34() {
        lhs_part_449 = sc_uint<49>(
    ...
    // part assign: lhs_part_450(1): inst_cellmath__211__182(4,0)
    sc_signal<sc_uint<5> > lhs_part_450;
    void method_51() {
        lhs_part_450 = sc_uint<5>(
    ...
    // part assign: lhs_part_451(1): inst_cellmath__220__188(22,0)
    sc_signal<sc_uint<23> > lhs_part_451;
    void method_53() {
        lhs_part_451 = sc_uint<23>(
    ...
    // part assign: lhs_part_452(2): x(31,0)
    sc_signal<sc_uint<32> > lhs_part_452;
    void method_66() {
        lhs_part_452 = sc_uint<32>(
...
#      else
    ...
    // !!!! amethyst/writers/SystemC.cpp:5668
        SC_METHOD(method_67);
        SC_METHOD(method_68);
        sensitive << lhs_part_439
                  << lhs_part_452
                  << lhs_part_453;
        SC_METHOD(method_69);
        sensitive << lhs_part_440;
        SC_METHOD(method_70);
        sensitive << lhs_part_441;
        SC_METHOD(method_71);
        sensitive << lhs_part_442
                  << lhs_part_443;
        SC_METHOD(method_72);
        sensitive << lhs_part_444
                  << lhs_part_446;
        SC_METHOD(method_73);
        sensitive << lhs_part_445
                  << lhs_part_447
                  << lhs_part_448;
        SC_METHOD(method_74);
        sensitive << lhs_part_449;
        SC_METHOD(method_75);
        sensitive << lhs_part_450;
        SC_METHOD(method_76);
        sensitive << lhs_part_451;
    }
#   endif // !defined(CYNTHVLG)
};
#endif //  #ifndef DFT_compute_cynw_cm_float_sin_E8_M23_2_COMPILED

/* CADENCE  vrX3Tg3Yog== : u9/ySgnWtBlWxVPRXgAZ4Og= ** DO NOT EDIT THIS LINE **/
