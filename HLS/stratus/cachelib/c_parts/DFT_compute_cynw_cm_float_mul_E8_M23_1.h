...
/*****************************************************************************
    ...
    Configured at: 11:22:24 CST (+0800), Sunday 24 April 2022
    Configured on: ws45
...
#ifndef DFT_compute_cynw_cm_float_mul_E8_M23_1_COMPILED
#define DFT_compute_cynw_cm_float_mul_E8_M23_1_COMPILED

SC_MODULE(DFT_compute_cynw_cm_float_mul_E8_M23_1) // architecture "behavioural"
{
...
#    if !defined(CYNTHVLG)
    ...
    // part assign: lhs_part_436(1): inst_i_mul_int_mult_datapath_prodSum(47,0)
    sc_signal<sc_uint<48> > lhs_part_436;
    void method_19() {
        lhs_part_436 = sc_uint<48>(
    ...
    void method_40() { 
        ...
        temp_40(47,0) = lhs_part_436.read();
        inst_i_mul_int_mult_datapath_prodSum = temp_40;
}
#     endif // !defined(CYNTHVLG)

    SC_CTOR(DFT_compute_cynw_cm_float_mul_E8_M23_1)
#   if defined(CYNTHVLG)
    ;
#      else
    {
    ...
    // !!!! amethyst/writers/SystemC.cpp:5668
        ...
        SC_METHOD(method_40);
        sensitive << lhs_part_436;
    }
#   endif // !defined(CYNTHVLG)
};
#endif //  #ifndef DFT_compute_cynw_cm_float_mul_E8_M23_1_COMPILED

/* CADENCE  urb0QgHbqw== : u9/ySgnWtBlWxVPRXgAZ4Og= ** DO NOT EDIT THIS LINE **/
