...
#ifndef cynw_cm_float_mul_E8_M23_COMPILED
#define cynw_cm_float_mul_E8_M23_COMPILED

SC_MODULE(cynw_cm_float_mul_E8_M23) // architecture "behavioural"
{
...
#    if !defined(CYNTHVLG)
    ...
    // part assign: lhs_part_60(1): inst_i_mul_int_mult_datapath_prodSum(47,0)
    sc_signal<sc_uint<48> > lhs_part_60;
    void method_19() {
        lhs_part_60 = sc_uint<48>(
...
#      else
    ...
    // !!!! amethyst/writers/SystemC.cpp:5668
        ...
        SC_METHOD(method_40);
        sensitive << lhs_part_60;
    }
#   endif // !defined(CYNTHVLG)
};
#endif //  #ifndef cynw_cm_float_mul_E8_M23_COMPILED

/* CADENCE  urbzTw7dqw== : u9/ySgnWtBlWxVPRXgAZ4Og= ** DO NOT EDIT THIS LINE **/
