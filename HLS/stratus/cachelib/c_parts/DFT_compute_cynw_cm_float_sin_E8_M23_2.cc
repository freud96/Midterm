...
/*****************************************************************************
    ...
    Configured at: 11:20:40 CST (+0800), Sunday 24 April 2022
    Configured on: ws45
...
#if !defined DFT_compute_cynw_cm_float_sin_E8_M23_2_INCLUDED
#define DFT_compute_cynw_cm_float_sin_E8_M23_2_INCLUDED

struct class_DFT_compute_cynw_cm_float_sin_E8_M23_2 { // BDW_REPLACE_NAME cynw_cm_float_sin
...
#endif // !defined DFT_compute_cynw_cm_float_sin_E8_M23_2_INCLUDED
    // !!!! amethyst/writers/SystemCbeh.cpp:4142
// cynw_cm_float_sin - cynth invocation function


inline void DFT_compute_cynw_cm_float_sin_E8_M23_2( // module DFT_compute_cynw_cm_float_sin_E8_M23_2
    const sc_uint<1>& a_sign // input  a_sign : unsigned
    ,const sc_uint<8>& a_exp // input  a_exp[7:0] : unsigned
    ,const sc_uint<23>& a_man // input  a_man[22:0] : unsigned
    ,sc_uint<37>& x // output  x[36:0] : unsigned
...
{
    static class_DFT_compute_cynw_cm_float_sin_E8_M23_2 target; // BDW_REPLACE_NAME
    target(
        a_sign,
        a_exp,
        a_man,
