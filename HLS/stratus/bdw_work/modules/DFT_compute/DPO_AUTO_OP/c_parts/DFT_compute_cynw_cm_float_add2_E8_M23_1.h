...
#ifndef DFT_compute_cynw_cm_float_add2_E8_M23_1_COMPILED
#define DFT_compute_cynw_cm_float_add2_E8_M23_1_COMPILED

SC_MODULE(DFT_compute_cynw_cm_float_add2_E8_M23_1) // architecture "behavioural"
{
...
temp_18 = (sc_uint<8>)((sc_uint<8>)(inst_cellmath__51_tmp_9))
    ...
    // part assign: lhs_part_437(1): inst_cellmath__68__38(25,0)
    sc_signal<sc_uint<26> > lhs_part_437;
    void method_35() {
        lhs_part_437 = sc_uint<26>(
    ...
    // part assign: lhs_part_438(1): inst_cellmath__71(24,0)
    sc_signal<sc_uint<25> > lhs_part_438;
    void method_58() {
        lhs_part_438 = sc_uint<25>(
...
#      else
    ...
    // !!!! amethyst/writers/SystemC.cpp:5668
        ...
        SC_METHOD(method_62);
        sensitive << lhs_part_437;
        SC_METHOD(method_63);
        sensitive << lhs_part_438;
    }
#   endif // !defined(CYNTHVLG)
};
#endif //  #ifndef DFT_compute_cynw_cm_float_add2_E8_M23_1_COMPILED

/* CADENCE  uLL0QwHcrQ== : u9/ySgnWtBlWxVPRXgAZ4Og= ** DO NOT EDIT THIS LINE **/
