...
sc_uint<8> DFT_compute::reverse_bits(sc_uint<8> input)
{
    ...
    {
#ifdef PIPELINE
        HLS_UNROLL_LOOP( COMPLETE,3, "loop" );        
#endif
#ifdef UNROLL
       // HLS_CONSTRAIN_LATENCY(0, 1, "lat00");
...
void DFT_compute::bit_reverse(Float temp_real[],Float temp_imag[])
{
    ...
    {
#ifdef PIPELINE
        HLS_PIPELINE_LOOP(SOFT_STALL, 4, "Loop2" );
#endif
#ifdef UNROLL
        HLS_UNROLL_LOOP( COMPLETE, 3, "my_loop" );
#endif
