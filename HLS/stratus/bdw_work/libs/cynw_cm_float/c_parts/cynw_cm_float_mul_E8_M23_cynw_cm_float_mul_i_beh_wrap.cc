#include "/home/m110/m110061422/EE6470/mid_v3/stratus/bdw_work/libs/cynw_cm_float/c_parts/cynw_cm_float_mul_E8_M23.cc"
#include "esc.h"

extern "C" {

void cynw_cm_float_mul_E8_M23_cynw_cm_float_mul_i_instruction_beh( qbhValueRecord** vals )
{
  ...
  sc_uint< 32 > x;
  cynw_cm_float_mul_E8_M23( a_sign, a_exp, a_man, b_sign, b_exp, b_man, x );
